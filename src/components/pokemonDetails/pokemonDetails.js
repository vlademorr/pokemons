...
const PokemonDetails = ({pokemonDetails, loading, showContent}) => {
    ...
    return (
        <div className="pokemon_details_container">
            <img
                ...
                onMouseOver={(e) => {
                    e.currentTarget.src = pokemonDetails.sprites.back_default;
                }}
                onMouseLeave={(e) => {
                    e.currentTarget.src = pokemonDetails.sprites.front_default;
                }}
